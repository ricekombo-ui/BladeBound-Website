...
export const metadata: Metadata = {
  title: "About",
  description:
    "Learn about Daniel and the story behind BladeBound Saga, a Daggerheart-focused content brand built around narrative-first play.",
};
      ...
      <section className="bg-void border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          ...
          <p className="text-stone text-lg md:text-xl max-w-2xl leading-relaxed">
            BladeBound Saga started with a simple conviction: the best tabletop experiences happen when story and mechanics work together, not against each other.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <div className="space-y-4 text-stone text-base leading-relaxed">
              ...
              <p>
                So I went deep. I learned the system inside out. I built content around it. I started running professional games through StartPlaying. And eventually, BladeBound Saga became the brand that holds all of that work together.
              </p>
              <p>
          ...
          <div className="space-y-4">
            {[
              ...
              {
                title: "Founder, BladeBound Saga",
                body: "Built BladeBound Saga to serve the Daggerheart community with content, games, and resources that actually move the needle.",
              },
              {
      ...
      <SectionWrapper>
        <div className="max-w-3xl">
          ...
          <div className="space-y-4 text-stone text-base leading-relaxed">
            ...
            <p>
              That is what BladeBound Saga is. A focused, serious, craft-oriented space for people who want to play Daggerheart well and think about why it works.
            </p>
          </div>
        </div>
      </SectionWrapper>
